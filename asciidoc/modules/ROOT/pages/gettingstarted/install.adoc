...
You can install Easykube in a few ways; here are some of the paths you can choose.
...
* https://www.docker.com/[docker] / https://podman.io/[podman]
...
* https://github.com/containers/skopeo[skopeo] (optional, however some addons might require it)
...
Next: proceed to xref:./configure.adoc#configure[configure easykube icon:arrow-right[role="big"]]
