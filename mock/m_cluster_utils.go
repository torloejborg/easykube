...
func (m *MockIClusterUtils) RenderToYAML(addonList []ez.IAddon, data ez.EasykubeConfigData) string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RenderToYAML", addonList, data)
	ret0, _ := ret[0].(string)
	return ret0
}

// RenderToYAML indicates an expected call of RenderToYAML.
func (mr *MockIClusterUtilsMockRecorder) RenderToYAML(addonList, data any) *MockIClusterUtilsRenderToYAMLCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RenderToYAML", reflect.TypeOf((*MockIClusterUtils)(nil).RenderToYAML), addonList, data)
