...
//
//	mockgen -typed --source pkg/ez/k8s_utils.go --destination mocks/m_k8s_utils.go
//
...
func (m *MockIK8SUtils) CreateSecret(namespace, secretName string, data map[string]string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "CreateSecret", namespace, secretName, data)
}
...
// Return rewrite *gomock.Call.Return
func (c *MockIK8SUtilsCreateSecretCall) Return() *MockIK8SUtilsCreateSecretCall {
	c.Call = c.Call.Return()
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockIK8SUtilsCreateSecretCall) Do(f func(string, string, map[string]string)) *MockIK8SUtilsCreateSecretCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockIK8SUtilsCreateSecretCall) DoAndReturn(f func(string, string, map[string]string)) *MockIK8SUtilsCreateSecretCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
